...
def main():
    ...
    task_args.framework = "megatron"

    task_log_dir = helper.init_flagperf_logger(START_LOGGER, task_args)
    helper.write_pid_file(task_args.log_dir, "start_megatron_task.pid")
    ...
    exec_cmd = exec_cmd + " --master_addr=" + task_args.master_addr
    exec_cmd = exec_cmd + " --master_port=" + str(task_args.master_port)
